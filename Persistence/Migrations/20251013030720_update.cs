    ...
    public partial class update : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScannerDevices", x => x.ScanId);
                    table.ForeignKey(
                        name: "FK_ScannerDevices_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolName = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScannerDevices_SchoolId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_SchoolName_UserName",
                table: "Users",
                columns: new[] { "SchoolName", "UserName" },
                unique: true,
                filter: "[SchoolName] IS NOT NULL AND [UserName] IS NOT NULL");
